      ...
      <div class="footer-grid">
        <div class="footer-column company-info">
          <div class="logo-wrapper">
            <img src="@/assets/logobg.png" alt="Logo Perusahaan" class="footer-logo" />
          </div>
          <p class="company-tagline">Solusi Percetakan Lengkap dan Berkualitas Tinggi</p>
          <p class="footer-description">
            Bigger Digital Printing menyediakan layanan percetakan berkualitas tinggi dengan teknologi modern dan tim profesional yang siap membantu mewujudkan kebutuhan cetak Anda.
          </p>
        ...
        <div class="footer-column">
          ...
          <nav class="footer-nav">
            <a href="#" @click.prevent="handleNav({ label: 'Home', id: null, page: '/' })" class="nav-link">
              <span class="link-icon">→</span>
              <span>Home</span>
            </a>
            <a href="#" @click.prevent="handleNav({ label: 'About', id: 'about-us', page: '/' })" class="nav-link">
              <span class="link-icon">→</span>
              <span>About</span>
            </a>
            <a href="#" @click.prevent="handleNav({ label: 'Services', id: 'services', page: '/services' })" class="nav-link">
              <span class="link-icon">→</span>
              <span>Services</span>
            </a>
            <a href="#" @click.prevent="handleNav({ label: 'Payment', id: 'payment', page: '/' })" class="nav-link">
              <span class="link-icon">→</span>
              <span>Payment</span>
            </a>
          </nav>
        ...
        <div class="footer-column">
          ...
          <div class="hours-card">
            <div class="hours-item">
              ...
              <div class="time-label">08.00 - 18.00 WIT</div>
            </div>
          ...
          <div class="contact-info">
            ...
            <div class="info-item">
              <span class="info-icon">📧</span>
              <span>biggerdigitalprinting@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
...
const socials = {
  ...
  facebook: 'https://www.facebook.com/biggersingaraja'
}
...
.footer-section {
  position: relative;
  background: linear-gradient(135deg, #151516 100%, #70707d 50%, #92929d 100%);
  color: #ffffff;
  padding: 5rem 0 0;
  margin-top: -5px;
